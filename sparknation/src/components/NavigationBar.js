	...
	render() {
		return (
			<nav className="navbar navbar-custom navbar-expand-sm">
				...
				<button className="navbar-toggler" data-toggle="collapse" data-target="#navbar_menu">
				...
				<div className="collapse navbar-collapse" id="navbar_menu">
					<ul className="navbar-nav">
	  					<li className="navbar-item px-3"> 
	  						<button className="btn btn-outline-primary btn-lg navbar-link" type="button">
	  							Explore
	  						</button>
	  					</li>
	  					<li className="navbar-item px-3"> 
  					...
  					<ul className="navbar-nav ml-auto">
	  					<li className="navbar-item px-5"> 
	  						<button className="btn btn-outline-secondary btn-lg navbar-link" type="button">
	  							Sign In
	  						</button>
	  					</li>
  					</ul>
